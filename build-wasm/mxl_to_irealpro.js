...
function findWasmBinary() {
    return locateFile('mxl_to_irealpro.wasm');
}
...
function assignWasmExports(wasmExports) {
  Module['_parse_musicxml_song'] = _parse_musicxml_song = createExportWrapper('parse_musicxml_song', 3);
  ...
  Module['_irp_get_playlist_html'] = _irp_get_playlist_html = createExportWrapper('irp_get_playlist_html', 3);
